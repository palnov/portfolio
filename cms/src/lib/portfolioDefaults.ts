...
export const defaultProjects: ProjectRecord[] = [
  { title: 'ЖК «Солнечный Парк»', slug: 'residence', category: 'business', kind: 'real estate / landing', tags: 'Позиционирование · заявки · презентация', fallbackCover: '/portfolio-assets/residence.png', previewUrl: 'https://palnov.ru/cases/residence/', sortOrder: 1, cardVariant: 'wide', overlayLineOne: 'premium', overlayLineTwo: 'real estate', alt: 'ЖК «Солнечный Парк»' },
  { title: 'AURA Furniture', slug: 'aura', category: 'business', kind: 'e-commerce / catalog', tags: 'Каталог · визуальный язык · корзина', fallbackCover: '/portfolio-assets/aura.png', previewUrl: 'https://palnov.ru/cases/aura/', sortOrder: 2, coverClassName: 'project-cover--aura', overlayLineOne: 'objects', overlayLineTwo: 'with soul', alt: 'AURA Furniture' },
  { title: 'BURO Coffee', slug: 'buro', category: 'lifestyle', kind: 'brand site / shop', tags: 'Бренд · магазин · атмосфера', fallbackCover: '/portfolio-assets/coffee.png', previewUrl: 'https://palnov.ru/cases/buro/', sortOrder: 3, overlayLineOne: 'specialty', overlayLineTwo: 'coffee', alt: 'BURO Coffee' },
  { title: 'Тёплая корка', slug: 'bakery', category: 'lifestyle', kind: 'bakery / e-commerce', tags: 'Каталог · заказ · локальный бренд', fallbackCover: '/portfolio-assets/bakery.png', previewUrl: 'https://palnov.ru/cases/bakery/', sortOrder: 4, overlayLineOne: 'daily', overlayLineTwo: 'bread', alt: 'Тёплая корка' },
  { title: 'БРЕВДОМ', slug: 'brewdom', category: 'business', kind: 'construction / catalog', tags: 'Доверие · каталог · лидогенерация', fallbackCover: '/portfolio-assets/brewdom.jpg', previewUrl: 'https://palnov.ru/cases/brewdom/', sortOrder: 5, cardVariant: 'wide', overlayLineOne: 'built', overlayLineTwo: 'to last', alt: 'БРЕВДОМ' },
  { title: 'ВЕРЕСК Glamping', slug: 'glamping', category: 'lifestyle', kind: 'hospitality / booking', tags: 'Бронирование · контент · премиум', fallbackCover: '/portfolio-assets/glamping.png', previewUrl: 'https://palnov.ru/cases/glamping/', sortOrder: 6, overlayLineOne: 'slow', overlayLineTwo: 'escape', alt: 'ВЕРЕСК Glamping' },
  { title: 'Dental Clinic', slug: 'dentist', category: 'services', kind: 'medical / service', tags: 'Сервис · доверие · запись', fallbackCover: '/portfolio-assets/dentist.png', previewUrl: 'https://palnov.ru/cases/dentist/', sortOrder: 7, overlayLineOne: 'care', overlayLineTwo: 'in detail', alt: 'Dental Clinic' },
  { title: 'AION — верните себе время', slug: 'aion', category: 'services', kind: 'ai / automation', tags: 'AI · сценарии · продукт', visualMode: 'orb', orbLabel: 'AION', previewUrl: 'https://palnov.ru/cases/aion/', sortOrder: 8, cardVariant: 'wide', overlayLineOne: 'time', overlayLineTwo: 'as a system', alt: 'AION' },
  { title: 'Detailing Studio', slug: 'detailing', category: 'services', kind: 'automotive / service', tags: 'Сервис · до/после · запись', fallbackCover: '/portfolio-assets/detailing.png', previewUrl: 'https://palnov.ru/cases/detailing/', sortOrder: 9, overlayLineOne: 'care', overlayLineTwo: 'for motion', alt: 'Detailing Studio' },
  { title: 'WILDLINE — выйти за карту', slug: 'adventure', category: 'concept', kind: 'visual concept / landing', tags: 'Концепт · арт-дирекшн · mood', fallbackCover: '/portfolio-assets/adventure.png', previewUrl: 'https://palnov.ru/cases/adventure/', sortOrder: 10, overlayLineOne: 'find', overlayLineTwo: 'the edge', alt: 'WILDLINE' },
  { title: 'MATERIA Interiors', slug: 'renovation', category: 'business', kind: 'interiors / landing', tags: 'Премиум · scrollytelling · заявка', fallbackCover: '/portfolio-assets/materia.webp', previewUrl: 'https://palnov.ru/cases/renovation/', sortOrder: 11, cardVariant: 'wide', overlayLineOne: 'crafted', overlayLineTwo: 'interiors', alt: 'MATERIA Interiors' },
  { title: 'Право на новый этап', slug: 'bfl', category: 'services', kind: 'legal / lead generation', tags: 'Маршрутизация · доверие · заявка', fallbackCover: '/portfolio-assets/bfl.png', previewUrl: 'https://palnov.ru/cases/bfl/', sortOrder: 12, cardVariant: 'wide', overlayLineOne: 'clarity', overlayLineTwo: 'before contract', alt: 'Право на новый этап' },
]
